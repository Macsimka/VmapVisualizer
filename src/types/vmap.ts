export const VMAP_MAGIC_VERSIONS: readonly string[] = ["VMAP_4.E", "VMAP_4.F"];
export const RAW_VMAP_MAGIC_VERSIONS: readonly string[] = ["VMAP04E", "VMAP04F"];
...
export const MAP_VERSION_MAGIC_VERSIONS: readonly number[] = [10, 11];
export const MAP_VERSION_MAGIC = MAP_VERSION_MAGIC_VERSIONS[0];
